  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="bg-white shadow-md rounded-lg p-6 md:p-8">
        ...
        <div className="mb-6">
          <label htmlFor="coverImage" className="block text-sm font-medium text-gray-700 mb-1">Cover Image URL (Optional)</label>
          <input
            type="url"
            id="coverImage"
            {...register('coverImage')}
            placeholder="https://example.com/image.jpg"
            className={`mt-1 block w-full px-3 py-2 border ${errors.coverImage ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
          />
