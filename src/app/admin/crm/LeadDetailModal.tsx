...
export default function LeadDetailModal({ leadId }: Props) {
  ...
  return (
    <div className="space-y-4 max-h-[80vh] overflow-y-auto pr-2">
      <h2 className="text-2xl font-bold">Lead Detailsyyy</h2>
      <div className="text-sm space-y-1">
        ...
        <div><span className="font-semibold">Assigned Agent:</span> {lead.agent ? (lead.agent.name || lead.agent.email) : 'Unassigned'}</div>
